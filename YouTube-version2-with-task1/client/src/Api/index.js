...
export const getUserPoints = (userId) => API.get(`/updatePoints/getUserPoints/${userId}`);
// export const markWatched = (userId, videoId) => API.post(`/watchVideos/markWatched`, { userId, videoId });
export const updatePoints = (userId, points) =>API.post("/updatePoints", { userId, points });
